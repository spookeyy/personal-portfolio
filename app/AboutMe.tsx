      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            {/* Image column - now first in the DOM but will appear on the right visually */}
            ...
            {/* Content column - now second in the DOM but will appear on the left visually */}
            <div className="lg:order-1">
              <h2 className="text-4xl font-bold mb-6">About Me</h2>
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
                  I'm Kataboi Meshack, a passionate Software Developer based in
                  Nairobi, Kenya, with a strong focus on building scalable and
                  user-friendly web and mobile applications. My stack includes
                  React, React Native, TypeScript, Golang, and PostgreSQL, and I
                  enjoy solving real-world problems through clean, maintainable
                  code.
                </p>
                <p>
                  I've had the opportunity to work on impactful projects, from
                  streamlining delivery logistics with ParcelPoa to improving
                  customer engagement at Britam through chatbot automation and
                  travel insurance platforms. I also lead the development of a
                  youth-focused savings app, integrating real-time features and
                  secure saving mechanisms.
                </p>
                <p>
                  My workflow blends frontend precision with backend efficiency,
                  supported by tools like Git, Docker, and Agile practices. I
                  take pride in contributing to collaborative teams and always
                  strive to deliver work that's both functional and elegant.
                </p>
                <p>
                  I'm currently open to exciting opportunities where I can
                  continue to grow, innovate, and build technology that makes a
                  difference.
                </p>
              </div>
              ...
              <Tabs defaultValue="skills" className="mt-8">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                      ...
                      <p className="text-slate-300 text-sm">
                        ...
                        Python and Go. I build responsive web applications with
                        seamless API integration, focusing on performance and
                        user experience.
                      </p>
                    </div>
                    <div className="p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                ...
                <TabsContent value="experience" className="mt-6 space-y-4">
                  ...
                  <div className="p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                    ...
                    <p className="text-slate-300 text-sm">
                      ...
                      analytics display and improving user experience by 15% and
                      transparency by 50% through real-time tracking. Resolved
                      100+ bugs and ensured a secure platform.
                    </p>
                  </div>
                  <div className="p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                    <div className="flex items-center text-blue-400 font-semibold mb-2">
                    ...
                    <p className="text-slate-300 text-sm">
                      ...
                      and reaching the right people. Data is my best friend too
                      – I analyze results to see what's working and what's not.
                    </p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="education" className="mt-6 space-y-4">
                  ...
                  <div className="p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                    ...
                    <p className="text-slate-300 text-sm">
                      Professional Certification in Kubernetes and Cloud Native
                      Associate (KCNA) by Linux Foundation
                    </p>
                  </div>
                  {/* <div className="p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                      <div className="flex items-center text-blue-400 font-semibold mb-2">
